...
class Loader:
    ...
    - get_data_loader: Returns the data loading depending on the loader's purpose.
    - _generate_training_paths: Generates the training and validation dataset' paths.
    ...
    def get_data_loader(self):
        """
        Returns the data loading depending on the loader's purpose.

        Returns:
            - ((dict, dict)): the training and validation data loading.
        """
    ...
    def _generate_paths(self) -> tuple:
        """
        Generates the training and validation dataset' paths.

        Returns:
            - ((dict, dict)): the training and validation dataset' paths.
        """
        # Verify parameters
