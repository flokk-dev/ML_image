...
class Visualizer25D(Visualizer):
    """
    ...
    def __init__(self, model_name: str, params: dict, mode="online"):
        """
        Initialize the Visualizer25D class.
        ...
        """
        # Mother Class
        super(Visualizer25D, self).__init__(model_name, params, mode=mode)
