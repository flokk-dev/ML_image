...
# IMPORT: project
import paths
from toolbox_ml.metrics import SAE, RMSE


class Trainer:
    """
    The class training a given models.

    Attributes:
    - _model (Model): the models to train.
    - _name (str): the training's name.
    - _parameters (dict): the training's parameters.
    - _tuning (bool): if True, tune the models.
    ...
    - _train: Trains the models.
    - _train_fn: The training function.
    - _train_block: The training block.
    - _save: Saves the models's weights, its parameters and its results.
    - _save_results: Saves the models's parameters and its results.
    - _tune: Tunes the models's hyperparameters.
    """
    ...
    def _save(self):
        """
        Saves the models's weights, its parameters and its results.
        """
    ...
    def _save_results(self):
        """
        Saves the models's parameters and its results.
        """
        info = dict()
